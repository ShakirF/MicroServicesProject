...
public class BasketService : IBasketService
{
	...
	public async Task AddBasketItem(BasketItemViewModel basketItemViewModel)
	{
		...
		if (basket != null)
		{
			if (basket.BasketItems.Any(a => a.ProductId == basketItemViewModel.ProductId))
			{
				basket.BasketItems.FirstOrDefault
				(f => f.ProductId == basketItemViewModel.ProductId)
	...
	public async Task<BasketViewModel> Get()
	{
		...
		basketViewModel.Data.BasketItems.ForEach(x =>
		{
