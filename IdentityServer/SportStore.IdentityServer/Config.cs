...
namespace SportStore.IdentityServer
{
	public static class Config
	{
		...
		public static IEnumerable<IdentityResource> IdentityResources =>
				   new IdentityResource[]
				   {
					   ...
					   new IdentityResource()
					   {Name = "roles",DisplayName = "Roles", Description = "Istifadechi rollari",
						   UserClaims = new[]{"role"} }
				   };
		...
		public static IEnumerable<ApiScope> ApiScopes =>
			new ApiScope[]
			{
				new ApiScope("catalog_fullpermission","Catalog API ucun full access"),
				...
				new ApiScope("payment_fullpermission","Payment API ucun full access"),
			...
			new Client[]
			{
				...
				new Client
				{
					...
					AllowedScopes = {"basket_fullpermission",
						"order_fullpermission","gateway_fullpermission","discount_fullpermission","payment_fullpermission",
